...
function readme {
  ...
  printf "    ${GRAY}user:~/Documents/hosts-blocking$ ${NC}${GREEN}sudo ./run.sh --help${NC}\n"
  printf "\n"
  printf "    Copy blocking hosts data to your hosts file\n"
  printf "    ${GRAY}user:~/Documents/hosts-blocking$ ${NC}${GREEN}sudo ./run.sh --install${NC}\n"
  printf "\n"
  printf "    Revert to the previous state of your hosts file\n"
  printf "    ${GRAY}user:~/Documents/hosts-blocking$ ${NC}${RED}sudo ./run.sh --undo${NC}\n"
  printf "\n"
  printf "    Revert your hosts file to a stored backup by name\n"
  printf "    ${GRAY}user:~/Documents/hosts-blocking$ ${NC}${RED}sudo ./run.sh --revert-to=YYYYMMDD@HHMMSS${NC}\n"
  printf "\n\n"
